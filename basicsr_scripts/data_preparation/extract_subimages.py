...
def main():
    ...
    # HR images
    opt['input_folder'] = 'datasets/data/train/train_hr'
    opt['save_folder'] = 'datasets/data/train/240_960/train_hr'
    opt['crop_size'] = 960
    opt['step'] = 60
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = 'datasets/data/train/train_lr'
    opt['save_folder'] = 'datasets/data/train/240_960/train_lr'
    opt['crop_size'] = 240
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
